      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-dark-grey mb-4">
            Have questions or need assistance? Reach out to our team for support, inquiries, or feedback.
            We're always ready to assist you with any issues or concerns.
          </p>
          <ContactMethod
...
const ContactMethod = ({ iconSrc, title, detail }) => (
