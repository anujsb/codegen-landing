  ...
  const features = [
    {
      ...
      description: "Catch logical mistakes, best practice deviations, and non-idiomatic code"
    },
    {
      icon: "/Async.svg",
      title: "Async Code Generation",
      description: "Assign work to Eacc via GitHub comments, get working, tested code a few minutes later"
    },
    {
      icon: "/Question.svg",
    ...
    },
    {
      ...
      description: "Write your style guide in natural language, Ellipsis will flag violations"
    },
    {
      icon: "/Customize.svg",
      title: "Customize with Feedback",
      description: "Ellipsis learns which types of comments your team values, customizing reviews over time"
    },
    {
      icon: "/Generate.svg",
      title: "Generate Change Logs",
      description: "Create weekly summaries of what's changed in your codebase and why it matters"
    },
  ];
    ...
    <div className="container mx-auto px-4 my-16 lg:my-32 flex flex-col items-center justify-center">
      <div className="w-full lg:w-2/4 flex flex-col items-center justify-center text-center">
        <div className="flex items-center justify-center bg-sec-col border border-5black rounded-full px-2 py-1">
          <Image src="/Versatile.svg" width={15} height={15} alt="versatile icon" className="mr-1" />
          <div>Versatile AI assistant</div>
        </div>
        <h1 className="my-6 text-2xl lg:text-4xl">Beyond just LGTM-as-a-service</h1>
        <p className="text-dark-grey">Ellipsis functions as an AI teammate adept at answering questions, crafting release notes, developing features, and resolving build issues.</p>
      </div>
