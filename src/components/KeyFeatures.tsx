  ...
  <div className="bg-sec-col p-4 border shadow-sm rounded-2xl w-full lg:w-[428.27px] h-[386px]">
    <div className="flex flex-row items-center">
      ...
      <div className="p-4 bg-light-lavender rounded-full border">
        <Image src="/featuregrid.svg" width={10} height={10} alt="feature icon" />
      </div>
    </div>
    <div className="rounded-xl border mt-10">
  ...
  const features = [
    {
      ...
      description: "Instantly generate production-ready code by tagging @eacc-dev."
    },
    {
    ...
    <div className="container mx-auto px-4 my-16 lg:my-32 flex flex-col items-center justify-center">
      <div className="w-full lg:w-2/4 flex flex-col items-center justify-center text-center">
        <div className="flex items-center justify-center bg-sec-col border border-5black rounded-full px-2 py-1">
          <Image src="/KeyFeatures.svg" width={15} height={15} alt="key features icon" className="mr-1" />
          <div>Key Features</div>
        </div>
        <h1 className="my-6 text-2xl lg:text-4xl">Elevate Your Projects with SAP</h1>
        <p className="text-dark-grey">Automate code reviews, generate tested solutions, integrate seamlessly with Git, and evolve with user feedback—all in one powerful platform designed to accelerate your team's productivity and code quality.</p>
      </div>
